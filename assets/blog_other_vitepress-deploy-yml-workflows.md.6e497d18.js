import{_ as s,c as n,o as a,a as l}from"./app.e5fc1613.js";const D=JSON.parse('{"title":"Vite Deploy yml Workflows","description":"","frontmatter":{},"headers":[],"relativePath":"blog/other/vitepress-deploy-yml-workflows.md"}'),p={name:"blog/other/vitepress-deploy-yml-workflows.md"},e=l(`<h1 id="vite-deploy-yml-workflows" tabindex="-1">Vite Deploy yml Workflows <a class="header-anchor" href="#vite-deploy-yml-workflows" aria-hidden="true">#</a></h1><p><code>.github/workflows/deploy.yml</code></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;">name: Deploy</span></span>
